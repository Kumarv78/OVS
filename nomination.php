      ...
      <div class="modal-content">
		...
		<!--	
			...
			<div class="form-group">
              ...
              <input type="number" name="year"class="form-control" id="i6" placeholder="Enter Your age" size="3" max="100" required>
            </div>
            ...
            <div class="form-group">
              ...
              <button type="submit" name='nominate' class="btn btn-success btn-block" id="logbt"><span class="glyphicon glyphicon-plane"></span> Submit</button>
          </form>
        </div>
