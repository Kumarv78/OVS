...
<body>
  ...
  <form class="form-horizontal" role="form" action="csa.php" method="post">
		...
		<h2 class="text-warning">Join Treasurer</h2>
		<div class="radio">
	 ...
	 <div class="row">
  <center>
  <h1 class="text-success"><u>Department Of Civil</u></h1>
  </center>
  <center>
 ...
 <!-- <form class="form-horizontal" role="form" action="civ.php" method="post">-->
        ...
        <label><input type="radio" name="cs">Nitesh</label>
		  ...
		  <h2 class="text-warning">Joint Treasure</h2>
        <div class="radio">
        <label><input type="radio" name="js">Vijay</label>
        </div>
        <div class="radio">
        <label><input type="radio" name="js">Harish</label>
        </div>
		<div class="radio">
        <label><input type="radio" name="js">Rahul</label>
        </div>
		 <div class="radio">
        <label><input type="radio" name="js">Nitesh</label>
        </div>
