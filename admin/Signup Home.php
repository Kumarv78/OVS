 ...
 <div id='d3'>
  ...
  <option>MEC</option>
	  ...
	  <input id="i4" type="text" name="idno" placeholder="Enter Your ID Number" maxlength="8" required pattern="20[1][3-5]0[1-3][0-9][0-9]">&nbsp;&nbsp;<SPAN class="format">Ex-20120122</SPAN></br></br>
	   &nbsp;&nbsp;&nbsp;Roll Number
	  <input id="i4" type="text" name="rollno" placeholder="Enter Your Roll Number" maxlength="10" required pattern="BT[1][3-5][CEM]{1}[CSEI]{1}[VEC]{1}0[0-9][0-9]">&nbsp;&nbsp;<SPAN class="format">Ex-BT13MEC003</SPAN></br></br>
	   &nbsp;&nbsp;&nbsp;Upload Image
	   <input type="file" name="img"></br></br>
	  &nbsp;&nbsp;&nbsp;Email 
	  <input id="email" type="email" name="email" size="35" placeholder="Enter Your College Email Address" required patter="/([\._a-zA-Z0-9-]+@nituk.ac.in)+/i">&nbsp;&nbsp;<SPAN class="format">Ex-abcdef@nituk.ac.in</SPAN></br></br>
	  &nbsp;&nbsp;&nbsp;Mobile Number 
